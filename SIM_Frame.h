...
public:
    ...
    // motor_1st_order_JH240528
    /*float motor_time_const = 0.16;
    float last_calc_us;
    Vector3f mtorque_real;
    Vector3f mthrust_real;*/
...
//PAV_JH20240525
   ...
   const struct Model {
        ...
        // diameter of model
        // float diagonal_size = 0.35;
        // float diagonal_size = 3.5;
        float diagonal_size = 1.1; //Octo
        ...
        // Note that coaxial rotors count as one rotor only when calculating effective disc area
        //float disc_area = 0.385;
        //float disc_area = (1.57/2)*(1.57/2)*3.14; //62inch
        float disc_area = (0.2)*(0.2)*3.14; //Octo
        ...
        // if zero value will be estimated from mass
        //Vector3f moment_of_inertia;
        //Vector3f moment_of_inertia = {67.16, 127.77, 190.15};
        Vector3f moment_of_inertia = {0.75, 0.75, 1.5};
