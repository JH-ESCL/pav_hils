...
private:
    ...
    //B =   -0.3827    0.3827   -0.9239   -0.3827    0.3827    0.9239    0.9239   -0.9239 ; 
    //   0.9239   -0.9239    0.3827   -0.9239    0.9239   -0.3827    0.3827   -0.3827;  
    // -1.0000   -1.0000    1.0000    1.0000    1.0000    1.0000   -1.0000   -1.0000;
    //    1.0000    1.0000    1.0000    1.0000    1.0000    1.0000    1.0000    1.0000
    float Bv_inv[8][4] = {
        {-0.0957,  0.2310, -0.1250,  0.1250},
        { 0.0957, -0.2310, -0.1250,  0.1250},
        {-0.2310,  0.0957,  0.1250,  0.1250},
        {-0.0957, -0.2310,  0.1250,  0.1250},
        { 0.0957,  0.2310,  0.1250,  0.1250},
        { 0.2310, -0.0957,  0.1250,  0.1250},
        { 0.2310,  0.0957, -0.1250,  0.1250},
    ...
    float Bn[8][4] = {
        {-0.1387,  0.3355, -0.3193, -0.5160},
        { 0.5816, -0.0186,  0.2437, -0.3193},
        {-0.0155,  0.0601,  0.7027, -0.0490},
        {-0.3381, -0.4136, -0.3491, -0.3046},
        { 0.5249, -0.3104, -0.3046,  0.1881},
        {-0.1713,  0.6640, -0.0490,  0.1655},
        {-0.4714, -0.4084,  0.2878,  0.1677},
        { 0.0286,  0.0916, -0.2122,  0.6677}
    };
